...
- [x] **UI-TRACE-001**: When an answer's trace contains one or more tool calls, the system shall display them in a collapsible tool-trace section, in the order they occurred.
